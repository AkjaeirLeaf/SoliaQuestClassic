...
namespace SoliaQuestClassic.SoulForge.StatMods
{
    public class Arcane : SQStatMod
    {
        ...
        {
            SQWorld.Register(new Arcane());
            return 1;
        }

        //do stat overrides
        public const double STAT_WAVER = 0.5;
        public const double STAT_INCREASE = 1.9;
        public static double StatFunction(double baseStat, double input)
        {
            Arcane statMod = new Arcane();
