...
{
    public class Ordinary : SQStatMod
    {
        public Ordinary()
        {
            doDisplayName = false;
        ...
        {
            SQWorld.Register(new Ordinary());
            return 1;
        }

        //do stat overrides
        public const double STAT_WAVER = 0.2;
        public const double STAT_INCREASE = 0.0;
        public static double StatFunction(double baseStat, double input)
        {
            Ordinary statMod = new Ordinary();
