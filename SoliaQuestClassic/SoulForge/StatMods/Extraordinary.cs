...
{
    public class Extraordinary : SQStatMod
    {
        public Extraordinary()
        {
            internalID = "extraordinary";
        ...
        {
            SQWorld.Register(new Extraordinary());
            return 1;
        }

        //do stat overrides
        public const double STAT_WAVER = 0.25;
        public const double STAT_INCREASE = 0.47;
        public static double StatFunction(double baseStat, double input)
        {
            Extraordinary statMod = new Extraordinary();
