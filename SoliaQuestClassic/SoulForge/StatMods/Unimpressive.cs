...
{
    public class Unimpressive : SQStatMod
    {
        public Unimpressive()
        {
            internalID = "unimpressive";
            displayName = "Unimpressive";
            probability = 1.0/15;
        ...
        {
            SQWorld.Register(new Unimpressive());
            return 1;
        }

        //do stat overrides
        public const double STAT_WAVER = 0.35;
        public const double STAT_INCREASE = -0.47;
        public static double StatFunction(double baseStat, double input)
        {
            Unimpressive statMod = new Unimpressive();
