...
{
    public class Celestial : SQStatMod
    {
        public Celestial()
        {
            internalID = "celestial";
        ...
        {
            SQWorld.Register(new Celestial());
            return 1;
        }

        //do stat overrides
        public const double STAT_WAVER = 0.99;
        public const double STAT_INCREASE = 7.2;
        public static double StatFunction(double baseStat, double input)
        {
            Celestial statMod = new Celestial();
